...
public class UserRecommendServiceTest extends BaseTest{
	...
	public void testFindAll() throws Exception {
    	...
    	List<Map<String, String>> findAllByOpenIdAndDelFlag = userRecommendService.queryAllByOpenIdAndDelFlag("o5z7ywOP7qycrtAAxIqDfgMbfcFY", WechatConstant.delete_flag_1, pageable);
