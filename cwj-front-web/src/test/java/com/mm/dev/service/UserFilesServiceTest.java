...
public class UserFilesServiceTest extends BaseTest{
	...
	public void testQueryList() {
		List<UserFiles> selectAll = userFilesMapper.selectAll();
		System.out.println(JSONUtil.toJsonPrettyStr(selectAll));
	}
	
	@Test
	public void testFindPageList() {
		PageInfo<UserFiles> findPageListByWhere = userFilesService.findPageListByWhere(0, 10, null);
		System.out.println(JSONUtil.toJsonPrettyStr(findPageListByWhere));
	}
}
