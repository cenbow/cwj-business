 ...
 */
@Service
public class UserInOutDetailServiceImpl extends BaseServiceImpl<UserInOutDetail> implements IUserInOutDetailService {
...
//    }
	...
	public int batchSaveList(List<UserInOutDetail> userInOutDetailList) throws Exception{
		List<UserInOutDetail> list = userInOutDetailDao.save(userInOutDetailList);
