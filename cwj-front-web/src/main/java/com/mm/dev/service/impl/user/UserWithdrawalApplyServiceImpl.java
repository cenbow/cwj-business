 ...
 */
@Service
public class UserWithdrawalApplyServiceImpl extends BaseServiceImpl<UserWithdrawalApply> implements IUserWithdrawalApplyService {
...
//    }
	 ...
	 * @throws
	 */
	public Map<String, String> queryApplyCountByOpenIdAndApplyTime(UserWithdrawalApply userWithDrawalApply) throws Exception{
		return userWithdrawalApplyMapper.queryApplyCountByOpenIdAndApplyTime(userWithDrawalApply);
	}
}
