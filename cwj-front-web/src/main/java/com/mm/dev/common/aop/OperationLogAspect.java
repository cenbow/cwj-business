...
public class OperationLogAspect {
     ...
     * 定义日志切入点
     */
    @Pointcut("@annotation(com.mm.dev.common.annotation.OperationLog)")
    ...
    public void doAfterThrowing(JoinPoint joinPoint, Throwable e) {
        ...
        try {
            ...
            Log log = localLog.get();
            log.setTimeConsuming(System.currentTimeMillis() - startTime.get());
            log.setLogType(WechatConstant.log_type_error);
...
//     * @throws Throwable
//     */
//    @Around("@annotation(com.ivplay.annotation.OperationLog)")
