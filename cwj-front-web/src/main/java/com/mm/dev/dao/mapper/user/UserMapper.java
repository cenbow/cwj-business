...
public interface UserMapper extends BaseMapper<User>{
	 ...
	 */
	public Page<UserFiles> queryUserFilesList(@Param("pageable")Pageable pageable,@Param("openId") String openId) throws Exception;
	 ...
	 * @throws
	 */
	public Page<UserFiles> queryOrderPaymentUserFilesByOpenId(@Param("pageable")Pageable pageable,@Param("openId") String openId) throws Exception;
}
