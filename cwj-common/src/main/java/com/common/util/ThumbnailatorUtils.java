...
public class ThumbnailatorUtils {  
    ...
    public static BufferedImage ImgBufferedImage(String source,int width, int height, String format) {  
        BufferedImage buf = null;  
        try {  
            buf = Thumbnails.of(source).size(width, height).asBufferedImage();  
        } catch (IOException e) {  
     ...
     * @return     : BufferedImage
     */
    public static BufferedImage ImgBufferedImage(String source,Float scale, String format) {  
        BufferedImage buf = null;  
        try {  
        	buf = Thumbnails.of(source).scale(1f).outputQuality(scale).outputFormat("jpg").asBufferedImage();
        } catch (IOException e) {  
            e.printStackTrace();  
        }  
        return buf;  
    ...
    public static void main(String[] args) {
    	ImgThumb("C:\\Users\\Administrator\\Desktop\\t_20170831094234.jpg", "C:\\Users\\Administrator\\Desktop\\t_1.jpg", 852, 1280);
